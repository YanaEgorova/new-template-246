...
<?php } ?>
    ...
    <footer class="footer">
          ...
          <div class="container">
            <div class="footer__block">
              ...
              <ul class="sub-list">
                ...
                <li class="item">
                  <a href="./ingredients.html" class="text footer__link">Ingredients</a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="container">
        <p style="padding-top: 16px; margin-bottom: 1rem" class="text">
          *Any statements on this site or any materials or supplements distributed or sold by
          ...
          product is not intended to diagnose, treat, cure or prevent any disease. If you are pregnant, nursing, taking
          medication, or have a history of heart conditions we suggest consulting with a physician before using any of
          our products. The results on all products are not typical and not everyone will experience these results.
        </p>
      </div>
  </div>
